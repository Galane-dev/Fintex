...
export const AccountsModal = ({ controller, currentPrice }: AccountsModalProps) => {
  ...
  const { account, accountMetrics, sortedConnections } = controller;
