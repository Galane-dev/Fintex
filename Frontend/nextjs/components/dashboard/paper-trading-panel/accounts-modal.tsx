...
import { Alert, Button, Empty, Form, Input, InputNumber, Select, Space, Tabs, Tag, Typography } from "antd";
    ...
    !account ? (
      <div className={styles.section}>
        ...
        <Form form={controller.accountForm} layout="vertical" onFinish={(values) => void controller.handleAccountCreate(values)}>
          ...
          <Button type="primary" htmlType="submit" loading={getFintexButtonLoading(controller.isSubmitting)} className={styles.actionButton}>Create paper academy account</Button>
        </Form>
      </div>
    ) : (
      <div className={styles.section}>
