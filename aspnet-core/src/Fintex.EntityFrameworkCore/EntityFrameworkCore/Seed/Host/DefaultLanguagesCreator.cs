...
namespace Fintex.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly FintexDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = FintexConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(FintexDbContext context)
    {
        _context = context;
    }
