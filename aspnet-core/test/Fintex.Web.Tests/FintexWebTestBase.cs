...
public abstract class FintexWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static FintexWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(FintexWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<FintexDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<FintexDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<FintexDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<FintexDbContext, Task<T>> func)
    {
        T result;
