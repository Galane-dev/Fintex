...
using Fintex.Web.Host.Notifications;
...
namespace Fintex.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<NotificationEmailOptions>(_appConfiguration.GetSection("Notifications:Email"));
            ...
            services.AddTransient<INotificationEvaluationService, NotificationEvaluationService>();
            services.AddTransient<INotificationEmailSender, ZeptoMailNotificationEmailSender>();
